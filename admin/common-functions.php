 ...
 */
	...
	function nrelate_msg() {
			echo "<div id=\"nrelate_admin_error\" class=\"error fade\"><strong><p>nrelate needs help. Check your messages <a href=\"admin.php?page=nrelate-main\">here</a></p></strong></div>";
